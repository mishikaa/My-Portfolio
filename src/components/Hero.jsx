...
const Hero = () => {
  ...
  return (
    <section className='relative w-full min-h-screen mx-auto flex items-center overflow-hidden'>
      ...
      <div className='relative w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center 
      justify-between gap-8 sm:gap-10 lg:gap-16 py-20 sm:py-24 lg:py-0 px-4 sm:px-6 lg:px-12'>
        ...
        <div className='flex-1 flex flex-col lg:flex-row items-center lg:items-start gap-5 w-full'>
          ...
          <div className='flex-1 w-full'>
            <h1 className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 text-center lg:text-left leading-tight'>
              Hey, I'm <span className='bg-gradient-to-r from-purple-400 to-pink-600 text-transparent bg-clip-text'>Mishika</span>
            </h1>
            
            <div className='wrapper text-base sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-center lg:text-left'>
            ...
            {/* CTA Buttons */}
            <div className='mt-8 sm:mt-12 lg:mt-16 w-full flex flex-col sm:flex-row gap-4 justify-center lg:justify-start'>
              <a 
                ...
                bg-[length:200%] text-white font-bold text-sm sm:text-base
            ...
            <div className='mt-8 sm:mt-10 flex flex-wrap gap-3 sm:gap-4 justify-center lg:justify-start'>
              <div className='flex items-center gap-2.5 px-5 py-2.5 bg-green-500/30 border-2 border-green-400/80 
              rounded-full hover:bg-green-500/40 transition-all duration-300 backdrop-blur-md shadow-lg shadow-green-500/20'>
                <div className='w-2.5 h-2.5 rounded-full bg-green-400 animate-pulse shadow-lg shadow-green-400/70'></div>
                <span className='text-sm sm:text-base font-bold text-white'>Open to Opportunities</span>
              </div>
              <div className='flex items-center gap-2.5 px-5 py-2.5 bg-purple-500/30 border-2 border-purple-400/80 
              rounded-full hover:bg-purple-500/40 transition-all duration-300 backdrop-blur-md shadow-lg shadow-purple-500/20'>
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-purple-300" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <span className='text-sm sm:text-base font-bold text-white'>800+ Problems Solved</span>
              </div>
            </div>
          </div>
        </div>
